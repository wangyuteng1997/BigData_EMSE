...
# 
#  Notes : 
#  * the sizes of the legend and axes labels may need to be `manually 
#    adjusted (look for cex in this file and utility_optim_functions.R )
#  * the graphs produced are not perfect, they depend on the data so manual adjusting 
#    will often be required... 

### user data
#filenames <- c("random_search_quadratic_5.RData","lbfgs_quadratic_5.RData")
#filenames <- c("random_search_quadratic_5.RData","cmaes_quadratic_5.RData")
#filenames <- c("random_search_quadratic_2.RData","lbfgs_quadratic_2.RData")
#filenames <- c("random_search_ackley_2.RData","lbfgs_ackley_2.RData")
#filenames <- c("random_search_michalewicz_2.RData","lbfgs_michalewicz_2.RData")
#filenames <- c("random_search_schwefel_2.RData","lbfgs_schwefel_2.RData")
#filenames <- c("random_search_rastrigin_2.RData","lbfgs_rastrigin_2.RData")

filenames <- c("normal_search_sphere_5_sigma_0.05.RData","normal_search_sphere_5_sigma_0.1.RData","normal_search_sphere_5_sigma_1.RData","normal_search_sphere_5_sigma_5.RData",,"normal_search_sphere_5_sigma_10.RData")



# filenames <- c("./random_search_ackley_5.RData","./lbfgs_ackley_5.RData","./cmaes_ackley_5.RData")
...
txtwdth <- floor(dim(fbhmat[[1]])[2]/3)

# legend(x="topright", legend=thelegends, col=seq(1,no_files),lty=rep(1, no_files) , cex=0.7, text.width=txtwdth)
legend(x="bottomleft", legend=thelegends, col=seq(1,`no_files`),lty=rep(1, no_files) , cex=0.7, text.width=txtwdth)
