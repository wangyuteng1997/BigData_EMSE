...
##### user data #####
  nameoffun <- "quadratic" # "quadratic", "ackley", "michalewicz", "sphere", "rastrigin", "schwefel", "tunnel" ...
...
if (nameofoptim == "random_search") {
  ...
  param <- list(LB=-5,UB = 5,budget = budget,dim=zdim, xinit=c(-3.2,3.2),sigma=0.2) # param for normal_search
