### normal_search Algorithm  #######
### i.e. ES-(1+1) with constant sigma
#
# Programming notes
#
# current_par  : current best point
# current_value  : current best objective function value (of current_par)
# dim  : number of dimensions (i.e., unknowns)
# param : optimizer parameters. Should contain 
#         - param$LB, param$UB, the lower and upper bounds as either a scalar or a vector of size dim
#         - param$xinit , the initial point, a vector of dimension dim
#         - param$sigma , the standard deviation of the Normal perturbation
#
...
### TP1: remplacer ligne ci-dessous par la bonne commande, qui utilise par, current_par, sigma et dim
      stop("remplacer cette ligne par \"par <- ...\"")
