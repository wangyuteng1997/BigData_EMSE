...
% fonction �crite pour les SVR
% dessin des points d'apprentissage et du mod�le "appris"
% Suivant la dimension de l'espace de dessin 

%donn�es X et Y Les points Xi Yi pour la regression
% Xi est une colonne de Rn ( f cherch�e de Rn dans R)
% Les Xi sont stock�s dans X en ligne
global ikernel
ikernel=2;
load Modele X Y alph b
...
%trac� de la fonction obtenue par r�gression
if ndim==1
